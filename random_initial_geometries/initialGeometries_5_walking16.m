...
if isfile('random_initial_geometries/data/initial_3_walking16.mat')
    load('random_initial_geometries/data/initial_3_walking16.mat', 'X');
else
    X=[];
end;
...
while (1)
    ...
    save('random_initial_geometries/data/initial_3_walking16', 'X');
