...
if isfile('random_initial_geometries/data/initial_3_stairsDescend.mat')
    load('random_initial_geometries/data/initial_3_stairsDescend.mat', 'X');
else
    X=[];
end;
...
while (1)
    ...
    save('random_initial_geometries/data/initial_3_stairsDescend', 'X');
