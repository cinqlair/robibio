...
if isfile('random_initial_geometries/data/initial_3_jumpSquat.mat')
    load('random_initial_geometries/data/initial_3_jumpSquat.mat', 'X');
else
    X=[];
end;
...
while (1)
    ...
    save('random_initial_geometries/data/initial_3_jumpSquat', 'X');
