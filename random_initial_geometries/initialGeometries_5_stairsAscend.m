...
if isfile('random_initial_geometries/data/initial_3_stairsAscend.mat')
    load('random_initial_geometries/data/initial_3_stairsAscend.mat', 'X');
else
    X=[];
end;
...
while (1)
    ...
    save('random_initial_geometries/data/initial_3_stairsAscend', 'X');
