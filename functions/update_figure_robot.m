...
if (robot.motors.enable.hip)
    ...
    % Force vector
    set(gHandle.motor.forceVectors.hip,  'XData', [robot.motors.trajectories.hip.thigh(1), robot.motors.trajectories.hip.thigh(1) + 2*robot.motors.forceVectors.hip(1)]);
    set(gHandle.motor.forceVectors.hip,  'YData', [robot.motors.trajectories.hip.thigh(2), robot.motors.trajectories.hip.thigh(2) + 2*robot.motors.forceVectors.hip(2)]);
...
if (robot.motors.enable.knee)
    ...
    % Force vector
    set(gHandle.motor.forceVectors.knee,  'XData', [robot.motors.trajectories.knee.shang(1), robot.motors.trajectories.knee.shang(1) + 2*robot.motors.forceVectors.knee(1)]);
    set(gHandle.motor.forceVectors.knee,  'YData', [robot.motors.trajectories.knee.shang(2), robot.motors.trajectories.knee.shang(2) + 2*robot.motors.forceVectors.knee(2)]);
end
...
if (robot.motors.enable.ankle)
    ...
    % Force vector
    set(gHandle.motor.forceVectors.ankle,  'XData', [robot.motors.trajectories.ankle.foot(1), robot.motors.trajectories.ankle.foot(1) + 2*robot.motors.forceVectors.ankle(1)]);
    set(gHandle.motor.forceVectors.ankle,  'YData', [robot.motors.trajectories.ankle.foot(2), robot.motors.trajectories.ankle.foot(2) + 2*robot.motors.forceVectors.ankle(2)]);    
end
...
if (robot.motors.enable.hip_knee)
    ...
    % Forcevector
    set(gHandle.motor.forceVectors.hip_knee,  'XData', [robot.motors.trajectories.hip_knee.shang(1), robot.motors.trajectories.hip_knee.shang(1) + 2*robot.motors.forceVectors.hip_knee(1)]);
    set(gHandle.motor.forceVectors.hip_knee,  'YData', [robot.motors.trajectories.hip_knee.shang(2), robot.motors.trajectories.hip_knee.shang(2) + 2*robot.motors.forceVectors.hip_knee(2)]);
end;
...
if (robot.motors.enable.knee_ankle)
    ...
    % Unit vector
    set(gHandle.motor.forceVectors.knee_ankle,  'XData', [robot.motors.trajectories.knee_ankle.foot(1), robot.motors.trajectories.knee_ankle.foot(1) + 2*robot.motors.forceVectors.knee_ankle(1)]);
    set(gHandle.motor.forceVectors.knee_ankle,  'YData', [robot.motors.trajectories.knee_ankle.foot(2), robot.motors.trajectories.knee_ankle.foot(2) + 2*robot.motors.forceVectors.knee_ankle(2)]);
end;
