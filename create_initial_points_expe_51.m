...
motionNames = ["Cycling", "Sit_to_Stand", "Climbing_descend", "Lifting_Squat", "Stairs_descend", "Recovery", "Lifting_Stoop", "Stairs_ascend", "Walking_11", "Walking_16", "Squat_Jump", "Climbing_ascend"];
